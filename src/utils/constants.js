export const editNameButton = document.querySelector(".profile__button-change-name");
...
export const addCardButton = document.querySelector(".profile__button-add-photo");
